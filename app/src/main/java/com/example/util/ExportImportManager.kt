...
object ExportImportManager {
    ...
    fun generateCsvContent(data: ExportData): String {
        ...
        sb.append("ID,Date,Type,Amount,Title,Person Name,Category,Settled Status,Note\n")
        ...
        for (tx in data.transactions) {
            ...
            sb.append("${tx.id},$dateStr,$typeStr,$amountStr,$titleStr,$personStr,$categoryStr,$settledStr,$noteStr\n")
        }
        sb.append("\n")
        ...
        sb.append("Calculated Net Savings,${CurrencyUtils.format(netSavings)}\n")
